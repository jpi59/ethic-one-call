...
public final class EthicEcosystemMenu {
    ...
    public static void show(Activity activity, boolean darkMode) {
        ...
        if (appIcon != null) {
            ...
            icon.setImageResource(R.drawable.ic_ethic_one_call);
        }
        ...
        repoCard.addView(createActionRow(
                ...
                "github.com/jpi59/ethic-one-call",
                ink, muted, action,
                v -> activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/jpi59/ethic-one-call")))
        ));
        ...
        repoCard.addView(createActionRow(
                ...
                "gitlab.com/jpi59/ethic-one-call",
                ink, muted, action,
                v -> activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://gitlab.com/jpi59/ethic-one-call")))
        ));
        repoCard.addView(createDivider(activity, cardStroke));
        repoCard.addView(createActionRow(
                activity,
    ...
    public static void showLicenseDialog(Activity activity, boolean darkMode, int action, int surface) {
        AlertDialog d = new AlertDialog.Builder(activity)
                ...
                .setMessage("Ethic One Call · Copyright (C) 2026 jpi59\n\n" +
